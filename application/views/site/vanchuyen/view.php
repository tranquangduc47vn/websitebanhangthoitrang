<div class="container jm-content-page" style="padding: 30px 15px; max-width: 1200px; margin: 0 auto;">
    <div style="color: #999; font-size: 14px; margin-bottom: 20px;">
        ...
        <a href="<?php echo base_url('vanchuyen'); ?>" style="color: #666; text-decoration: none;">Chính sách vận chuyển</a> / 
    ...
    <div style="display: flex; flex-wrap: wrap; gap: 30px;">
        <div style="flex: 1; min-width: 300px; background: #fff; padding: 20px; border-radius: 4px;">
            <div style="color: #888; font-size: 13px; margin-bottom: 10px;">
                📅 Cập nhật: <?php echo date('d/m/Y H:i', strtotime($info->created_at)); ?>
            </div>
            ...
            <div class="vanchuyen-content" style="font-size: 15px; color: #333; line-height: 1.8; white-space: pre-line;">
                <?php echo $info->content; ?>
            </div>
            
            <div style="margin-top: 30px;">
                <a href="<?php echo base_url('vanchuyen'); ?>" style="color: #222; text-decoration: none; font-weight: bold; font-size: 14px;">
                    &larr; Quay lại danh sách chính sách
                </a>
            </div>
        </div>
