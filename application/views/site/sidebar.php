...
<div class="col-xs-12 col-sm-3 col-md-3 col-lg-3 clearpaddingl">
	<div class="panel panel-info" style="margin-bottom: 5px;">
	    ...
	    <div class="panel-body">
	  	    <form class="form-horizontal text-center" method="get" action="<?php echo site_url('tim-kiem'); ?>">
	...
	<div class="panel panel-info">
	  <div class="panel-body" style="padding:0px">
	  	<div class="list-group">
	  		...
	  		<!-- 🌟 KHỐI SẢN PHẨM NỔI BẬT (Dùng chung khung chuẩn với danh mục) -->
	  		<div class="list-group">
	  			<a href="#" class="list-group-item active">
		    		SẢN PHẨM NỔI BẬT
		  		</a>
		  		<a href="<?php echo base_url('product/news'); ?>" class="list-group-item">Sản phẩm mới</a>
		  		<a href="<?php echo base_url('ban-chay'); ?>" class="list-group-item">Sản phẩm bán chạy</a>
		  		<a href="<?php echo base_url('product/views'); ?>" class="list-group-item">Sản phẩm xem nhiều</a>
	  		</div>
			...
			<!-- 👕 DANH MỤC SẢN PHẨM ĐỘNG -->
	  		...
	  		?>
	  		<div class="list-group">
	  			<a href="<?php echo build_category_url($value->id); ?>" class="list-group-item active">
		    		<?php echo $value->name; ?>
		  		</a>
		  		<?php foreach ($value->sub as $val) { 
	  			...
	  			?>
		  			<a href="<?php echo build_category_url($val->id); ?>" class="list-group-item"><?php echo $val->name; ?></a>
		  		<?php } ?>
		 	</div>
	  		<?php } ?>
